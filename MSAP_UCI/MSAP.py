...
model1 =  g1(mod='None',inplanes=9).to(device)
model2 =  g2(mod='None',inplanes=9).to(device)
model3 =  g3(mod='None',inplanes=9).to(device)
...
# %%
torch.save(model, 'msap_uci_model.pt')
