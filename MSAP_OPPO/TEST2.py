...
#model =  resnext50_32x4d(num_classes=18, include_top=True).to(device)
#model = LSTM_CNN(input_dim=113, hidden_dim=16, num_layers=1, num_classes=18)

#model = CNN(input_channel=113, num_classes=18).to(device)
#model = CNN_GRU(input_dim=113,hidden_dim=512,num_classes=18)
#model = LSTM(input_size=113, hidden_size=256, num_layers=1, output_size=18)
...
model =  ATT(row=0, col=0, num_classes=18).to(device)
...
# %%
torch.save(model, 'ATT_oppo_model.pt')
